...
class Queue:
    """
    Class for dealing with queues to Performs basic operations of Data structure (Queues) likewise  here we will add to a queue, get the       queues & check the coordinates for queues.
    """
    ...
    def add_queue(self, points):
        """
        Queue operation i:e. Add points to the queue.
    ...
    def get_queues(self, image):
        """
        Queue operation i:e.Get queues from images.
    ...
    def check_coords(self, coords, initial_w, initial_h):
        """
        Checkings co-ordinates for queues.
        
        Arguments:
            coords : list of the coordinates.
        """
...
class PersonDetect:
    ...
    def draw_outputs(self, coords, frame, initial_w, initial_h):
        ...
        Returns:
            frame
            count of people i:e, totoal number of people
...
def main(args):
    ...
    try:
        ...
        print("Error loading queue file")
